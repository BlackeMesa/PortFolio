      ...
      <>
        ...
        <div className="app__footer-cards">
          <div className="app__footer-card">
            ...
            <a href="mailto:guillaumeduplessis@yahoo.fr" className="p-text">
              guillaumeduplessis@yahoo.fr
            </a>
          </div>
          <div className="app__footer-card">
            <img src={images.mobile} alt="mobile" />
            <a href="tel:+33 7 88 43 20 55 " className="p-text">
              +33 7 88 43 20 55
            </a>
          </div>
        </div>
        ...
        {!isFormSubmitted ? (
          ...
          <div>
            <h3 className="heade-text">Thank you for getting in touch</h3>
          </div>
        )}
      </>
    );
